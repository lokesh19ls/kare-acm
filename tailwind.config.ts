	...
	theme: {
		...
		extend: {
			colors: {
				...
				// ACM KARE Brand Colors
				'acm-orange': 'hsl(var(--acm-orange))',
				'acm-blue': 'hsl(var(--acm-blue))',
				'acm-green': 'hsl(var(--acm-green))',
				'acm-purple': 'hsl(var(--acm-purple))',
				'acm-yellow': 'hsl(var(--acm-yellow))',
				'acm-cyan': 'hsl(var(--acm-cyan))',
				'acm-pink': 'hsl(var(--acm-pink))',
				// Vibrant Colors
